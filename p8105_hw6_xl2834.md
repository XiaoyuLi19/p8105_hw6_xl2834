...
The distribution of r squared estimates is left-skewed, with a mean at
around 0.915. The distribution of log(β0∗β1) estimates has a heavy upper
tail, and its mean is about 2.
